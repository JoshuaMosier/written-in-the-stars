...
const GLYPHS: Record<string, GlyphDef> = {
  ...
  'e': { width: 18, data: [15, 3, 8, 3, 6, 8, 15, 8, 13, 13, 6, 13, 6, 8] },
  'f': { width: 12, data: [10, 20, 6, 19, 6, 0, -1, -1, 3, 14, 10, 14] },
  'g': { width: 19, data: [15, 11, 15, -2, 11, -6, 6, -6, -1, -1, 15, 11, 11, 14, 7, 14, 3, 10, 3, 4, 7, 0, 11, 0, 15, 3] },
  'h': { width: 19, data: [4, 21, 4, 0, -1, -1, 4, 11, 13, 11, 13, 0] },
  'i': { width: 8, data: [3, 21, 4, 20, 5, 21, 4, 22, 3, 21, -1, -1, 4, 14, 4, 0] },
  'j': { width: 10, data: [5, 21, 6, 20, 7, 21, 6, 22, 5, 21, -1, -1, 6, 14, 6, -4, 2, -7, -1, -4] },
  'k': { width: 17, data: [4, 21, 4, 0, -1, -1, 14, 14, 4, 6, -1, -1, 7, 8, 15, 0] },
  'l': { width: 8, data: [4,21, 4,0] },
  'm': { width: 30, data: [4, 10, 4, 0, -1, -1, 4, 10, 7, 14, 10, 14, 13, 10, 13, 0, -1, -1, 13, 10, 16, 14, 19, 14, 22, 10, 22, 0] },
  'n': { width: 19, data: [4, 10, 4, 0, -1, -1, 4, 10, 6, 14, 11, 14, 13, 10, 13, 0] },
  'o': { width: 19, data: [7, 14, 3, 10, 3, 4, 7, 0, 12, 0, 16, 4, 16, 10, 12, 14, 7, 14] },
  ...
  'r': { width: 13, data: [4, 10, 4, 0, -1, -1, 4, 10, 5, 12, 7, 14, 11, 13] },
  's': { width: 17, data: [14, 12, 12, 14, 9, 14, 7, 13, 7, 10, 9, 9, 13, 9, 14, 7, 14, 6, 12, 4, 9, 4, 7, 5] },
  't': { width: 12, data: [5, 21, 5, 2, -1, -1, 2, 14, 9, 14] },
  'u': { width: 19, data: [4, 14, 4, 6, 5, 3, 8, 2, 11, 2, 14, 3, 15, 7, -1, -1, 15, 14, 15, 7] },
