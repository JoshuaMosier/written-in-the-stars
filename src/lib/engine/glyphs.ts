...
const GLYPHS: Record<string, GlyphDef> = {
  ...
  '%': { width: 24, data: [21, 21, 3, 0, -1, -1, 9, 19, 9, 16, 6, 14, 3, 16, 3, 19, 6, 21, 9, 19, -1, -1, 17, 7, 14, 5, 14, 2, 17, 0, 20, 2, 20, 5, 17, 7] },
  '&': { width: 26, data: [23, 12, 21, 14, 17, 6, 15, 3, 11, 0, 7, 0, 4, 2, 3, 6, 5, 9, 10, 12, 14, 16, 12, 21, 9, 21, 7, 16, 15, 3, 20, 0, 23, 2] },
  ...
  '6': { width: 20, data: [16, 18, 15, 20, 10, 21, 5, 17, 4, 7, -1, -1, 4, 7, 7, 0, 14, 0, 16, 7, 14, 11, 8, 11, 4, 7] },
  '7': { width: 20, data: [17,21,7,0,-1,-1,3,21,17,21] },
  '8': { width: 20, data: [4, 18, 4, 14, 10, 11, 17, 7, 17, 3, 10, 0, 3, 3, 3, 7, 10, 11, 16, 14, 16, 18, 10, 21, 4, 18] },
  '9': { width: 20, data: [16, 14, 12, 8, 6, 8, 3, 14, 6, 21, 12, 21, 16, 14, -1, -1, 16, 14, 16, 9, 13, 1, 9, 0, 5, 1, 4, 3] },
  ...
  '?': { width: 18, data: [3, 16, 4, 19, 7, 21, 12, 21, 15, 17, 14, 13, 9, 10, 9, 7, -1, -1, 9, 2, 8, 1, 9, 0, 10, 1, 9, 2] },
  '@': { width: 27, data: [18, 13, 13, 16, 8, 13, 8, 8, 13, 5, 17, 8, -1, -1, 18, 13, 17, 8, 19, 5, 21, 5, 24, 10, 23, 15, 20, 19, 15, 21, 9, 20, 5, 17, 3, 12, 4, 6, 7, 2, 12, 0, 18, 1, 21, 3] },
  'A': { width: 18, data: [9,21,1,0,-1,-1,9,21,17,0,-1,-1,4,7,14,7] },
  'B': { width: 21, data: [4, 21, 4, 0, -1, -1, 4, 21, 13, 21, 16, 20, 18, 17, 18, 15, 16, 12, 13, 11, -1, -1, 4, 11, 13, 11, 16, 10, 18, 7, 18, 4, 16, 1, 13, 0, 4, 0] },
  ...
  'G': { width: 21, data: [18, 16, 15, 20, 9, 21, 5, 18, 3, 13, 3, 8, 5, 3, 9, 0, 15, 1, 18, 5, 18, 8, -1, -1, 13, 8, 18, 8] },
  ...
  'Q': { width: 22, data: [9, 21, 5, 18, 3, 13, 3, 8, 5, 3, 9, 0, 13, 0, 15, 1, 17, 3, 19, 8, 19, 13, 17, 18, 13, 21, 9, 21, -1, -1, 12, 4, 15, 1, 18, -2] },
  'R': { width: 21, data: [4, 21, 4, 0, -1, -1, 4, 21, 13, 21, 16, 20, 18, 18, 18, 14, 16, 12, 13, 11, -1, -1, 13, 11, 4, 11, -1, -1, 13, 11, 18, 0] },
  ...
  'e': { width: 18, data: [15, 3, 8, 4, 6, 8, 15, 8, 13, 13, 6, 13, 6, 8] },
  ...
  's': { width: 17, data: [14, 12, 12, 14, 7, 13, 7, 10, 14, 8, 14, 6, 11, 4, 7, 5] },
  't': { width: 12, data: [5, 21, 5, 2, -1, -1, 2, 14, 9, 14] },
  'u': { width: 19, data: [4, 14, 4, 6, 6, 2, 13, 2, 15, 6, -1, -1, 15, 14, 15, 6] },
