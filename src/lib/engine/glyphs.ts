...
const GLYPHS: Record<string, GlyphDef> = {
  ...
  'a': { width: 19, data: [15,14, 15,0, -1,-1, 15,11, 13,13, 11,14, 8,14, 6,13, 4,11, 3,8, 3,6, 4,3, 6,1, 8,0, 11,0, 13,1, 15,3] },
  'b': { width: 19, data: [4,21, 4,0, -1,-1, 4,10, 5,12, 7,14, 9,14, 11,12, 12,11, 13,10, 13,8, 12,2, 10,0, 8,0, 6,2, 4,10] },
  'c': { width: 18, data: [15,11, 13,13, 11,14, 8,14, 6,13, 4,11, 3,8, 3,6, 4,3, 6,1, 8,0, 11,0, 13,1, 15,3] },
  'd': { width: 19, data: [15,21, 15,0, -1,-1, 15,10, 14,12, 12,14, 10,14, 8,12, 7,11, 6,10, 6,8, 7,2, 9,0, 11,0, 13,2, 15,10] },
  'e': { width: 18, data: [6,8, 15,8, 15,10, 14,11, 13,12, 11,14, 9,14, 7,12, 6,11, 5,10, 5,8, 6,2, 8,0, 10,0, 12,2, 14,4] },
  'f': { width: 12, data: [10,21, 8,21, 7,20, 6,17, 6,0, -1,-1, 3,14, 10,14] },
  'g': { width: 19, data: [15,14, 15,-2, 14,-5, 13,-6, 11,-7, 8,-7, 6,-6, -1,-1, 15,11, 13,13, 11,14, 8,14, 6,13, 4,11, 3,8, 3,6, 4,3, 6,1, 8,0, 11,0, 13,1, 15,3] },
  ...
  'o': { width: 19, data: [8,14, 6,13, 4,11, 3,8, 3,6, 4,3, 6,1, 8,0, 11,0, 13,1, 15,3, 16,6, 16,8, 15,11, 13,13, 11,14, 8,14] },
  'p': { width: 19, data: [4,14, 4,-7, -1,-1, 4,11, 6,13, 8,14, 11,14, 13,13, 15,11, 16,8, 16,6, 15,3, 13,1, 11,0, 8,0, 6,1, 4,3] },
  'q': { width: 19, data: [15,14, 15,-7, -1,-1, 15,11, 13,13, 11,14, 8,14, 6,13, 4,11, 3,8, 3,6, 4,3, 6,1, 8,0, 11,0, 13,1, 15,3] },
