...
const GLYPHS: Record<string, GlyphDef> = {
  ...
  '6': { width: 20, data: [16,18,15,20,12,21,10,21,7,20,5,17,4,12,4,7,-1,-1,4,7,5,3,7,1,10,0,11,0,14,1,16,3,17,6,17,7,16,10,14,12,11,13,10,13,7,12,5,10,4,7] },
  ...
  '9': { width: 20, data: [16,14,15,11,13,9,10,8,9,8,6,9,4,11,3,14,3,15,4,18,6,20,9,21,10,21,13,20,15,18,16,14,-1,-1,16,14,16,9,15,4,13,1,10,0,8,0,5,1,4,3] },
  ...
  'e': { width: 18, data: [14,3, 10,0, 6,2, 6,8, 15,8, 13,13, 6,13, 6,8] },
  ...
  'y': { width: 16, data: [2,14, 8,0, -1,-1, 14,14, 8,0, 2,-7, 1,-7] },
